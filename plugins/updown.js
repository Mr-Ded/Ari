...
Asena.addCommand(
  ...
  async (message, match) => {
	...
	&width=1388&height=720&output=image&file_type=png&block_ads=true&no_cookie_banners=true&dark_mode=true&wait_for_event=networkidle`    let { buffer } = await getBuffer(url)
